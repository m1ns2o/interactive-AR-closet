...
# 마킹 색상 정의 (BGR 형식, violet 계열)
COLOR_FACE = (246, 92, 139)   # 얼굴: violet (#8b5cf6)
COLOR_SKIN = (200, 150, 180)  # 피부: 연한 보라색
COLOR_EYES = (150, 80, 120)   # 눈: 어두운 보라색
COLOR_HAIR = (255, 200, 220)  # 머리카락: 밝은 보라색
